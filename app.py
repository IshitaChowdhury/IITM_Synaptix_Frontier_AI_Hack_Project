"""
Live Codebase Copilot (Agentic AI)
Track 1: Applied GenAI

This agent uses Pathway's live document indexing to continuously
monitor a developer codebase. Any file addition, edit, or deletion
is reflected instantly in the AI's responses.

Use case:
- Developers ask questions about evolving codebases
- No re-indexing or redeployment required
"""
